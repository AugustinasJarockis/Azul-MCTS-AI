...
{
    public class SmallLinearValueNetwork : Module, INetwork
    {
        ...
        public SmallLinearValueNetwork(string modelPath = "") : base("SmallLinearValueNetwork")
        {
